...
- Name: src\api\specs\swapi.spec.ts >> SWAPI Integration Tests @api >> TC-API-003 — Buscar Millennium Falcon: GET /starships/10/ status 200 e name correto
- Location: src\api\specs\swapi.spec.ts:48:7
