...
- Name: src\api\specs\swapi.spec.ts >> SWAPI Integration Tests @api >> TC-API-002 — Validar contrato Zod do endpoint People /people/1/
- Location: src\api\specs\swapi.spec.ts:24:7
