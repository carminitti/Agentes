...
- Name: src\api\specs\swapi.spec.ts >> SWAPI Integration Tests @api >> TC-API-004 — API client: GET /people/ retorna lista paginada
- Location: src\api\specs\swapi.spec.ts:66:7
