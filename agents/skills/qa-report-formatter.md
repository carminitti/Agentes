---
name: qa-report-formatter
description: Template HTML dual-mode completo do reporter-qa — CSS design system (variáveis, layout, badges, donut chart, suite cards, modo técnico, tabs, log coloring), esqueleto HTML com placeholders e JavaScript de interatividade. Fonte de verdade para o formato visual do relatório QA.
---
