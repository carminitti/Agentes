...
- Name: visual.spec.ts >> Visual Regression Tests @visual >> TC-VIS-001 — Baseline homepage AutomationExercise
- Location: visual.spec.ts:10:7

# Error details

```
Error: A snapshot doesn't exist at C:\Users\gabriel.carminitti\Documents\claude\agentes\tmp_visual_1778256594\baselines\visual.spec.ts-snapshots\automationexercise-home-baseline-win32.png, writing actual.
```
