...
- Name: visual.spec.ts >> Visual Regression Tests @visual >> TC-VIS-002 — Baseline pagina de produtos AutomationExercise
- Location: visual.spec.ts:26:7

# Error details

```
Error: A snapshot doesn't exist at C:\Users\gabriel.carminitti\Documents\claude\agentes\tmp_visual_1778256594\baselines\visual.spec.ts-snapshots\automationexercise-products-baseline-win32.png, writing actual.
```
