...
- Name: src\api\specs\practiceexpand.spec.ts >> Practice Expand API @api >> TC-API-013 — Login e obter token no Practice Expand
- Location: src\api\specs\practiceexpand.spec.ts:45:7
