...
- Name: src\api\specs\practiceexpand.spec.ts >> Practice Expand API @api >> TC-API-014 — Criar nota autenticada no Practice Expand
- Location: src\api\specs\practiceexpand.spec.ts:67:7
