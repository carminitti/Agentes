...
- Name: src\api\specs\practiceexpand.spec.ts >> Practice Expand API @api >> TC-API-011 — Health check da API de notas
- Location: src\api\specs\practiceexpand.spec.ts:7:7
